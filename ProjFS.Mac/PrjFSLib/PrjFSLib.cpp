...
static PrjFS_Result HydrateFile(const char* absolutePath, const char* relativePath, FsidInode fsidNode, pid_t pid, const char* procname);
...
static PrjFS_Result HydrateFile(const char* absolutePath, const char* relativePath, FsidInode fsidNode, pid_t pid, const char* procname)
{
    ...
    FileMutexMap::iterator mutexIterator = CheckoutFileMutexIterator(fsidNode);
